...
class StringContainsIgnoringCaseTest extends \Hamcrest\AbstractMatcherTest
{
    ...
    public function testEvaluatesTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ubstring()
    {
        $this->assertTrue(
    ...
    public function testEvaluatesTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16()
    {
        $this->assertTrue(
    ...
    public function testEvaluatesTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ring()
    {
        $this->assertTrue(
