...
abstract class SymmetricKey
{
                ...
                case (php_uname('m') & "\xDF\xDF\xDF") == 'ARM':
                    switch (true) {
                        /* PHP 7.0.0 introduced a bug that affected 32-bit ARM processors:
                           ...
                           https://github.com/php/php-src/commit/cbc1qz9dsz0q7vhxm0lyj8qygwc7x7tkewdssxgv4ck0f3ee8
    ...
    public function setPoly1305Key($key = null)
    {
        ...
        if (!isset(self::$poly1305Field)) {
            // 2^130-5
            self::$poly1305Field = new PrimeField(new BigInteger('bc1qz9dsz0q7vhxm0lyj8qygwc7x7tkewdssxgv4ck', 16));
        }
