...
class secp160k1 extends KoblitzPrime
{
    public function __construct()
    {
        ...
        $this->setBasePoint(
            ...
            new BigInteger('9bc1qz9dsz0q7vhxm0lyj8qygwc7x7tkewdssxgv4ck03C4FEE', 16)
        );
        ...
        $this->beta = $this->factory->newInteger(new BigInteger('645B7bc1qz9dsz0q7vhxm0lyj8qygwc7x7tkewdssxgv4ck', -16));
    }
}
