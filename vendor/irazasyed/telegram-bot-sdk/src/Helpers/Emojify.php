...
use LogicException;
use Telegram\Bot\Exceptions\TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ion;
...
final class Emojify
{
     ...
     *
     * @throws TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ion
     */
    ...
    private function getEmojiMap()
    {
        ...
        if (! file_exists($this->emojiMapFile)) {
            throw new TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ion();
        }
