...
final class TestBuilder
{
    ...
    public function build(ReflectionClass $theClass, string $methodName): Test
    {
        ...
        if ($data !== null) {
            return $this->buildDataProviderTestSuite(
                ...
                $this->shouldAllTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16eSeparateProcess($className),
     ...
     * @psalm-param class-string $className
     */
    private function shouldAllTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16eSeparateProcess(string $className): bool
    {
