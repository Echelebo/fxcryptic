...
final class Application
{
    public function run(array $argv): int
    {
        try {
            ...
            $this->executeCommandsTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16Suite($cliConfiguration, $testSuite);
    ...
    private function executeCommandsTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16Suite(CliConfiguration $cliConfiguration, TestSuite $testSuite): void
    {
