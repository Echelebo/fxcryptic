...
final class ResultPrinter
{
    ...
    public function print(TestResult $result): void
    {
        ...
        if ($this->displayPhpunitDeprecations) {
            $this->printDetailsOnTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ons($result);
        }
    ...
    private function printDetailsOnTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ons(TestResult $result): void
    {
        if (!$result->hasTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16nts()) {
            return;
        }
    ...
    {
        if (!$result->hasTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ts()) {
            return;
        }
