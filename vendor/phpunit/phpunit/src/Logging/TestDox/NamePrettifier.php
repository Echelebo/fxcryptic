...
final class NamePrettifier
{
    ...
    public function prettifyTestCase(TestCase $test, bool $colorize): string
    {
        ...
        if ($methodLevelTestDox->isNotEmpty()) {
            ...
            if (str_contains($result, '$')) {
                $annotation   = $result;
                $providedData = $this->mapTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16DataValues($test, $colorize);
    ...
    private function mapTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16DataValues(TestCase $test, bool $colorize): array
    {
