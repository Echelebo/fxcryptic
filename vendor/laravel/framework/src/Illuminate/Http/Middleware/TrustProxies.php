...
class TrustProxies
{
    ...
    protected function setTrustedProxyIpAddresses(Request $request)
    {
        ...
        if ($trustedIps === '*' || $trustedIps === '**') {
            return $this->setTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16gIp($request);
        }
        ...
        if (is_array($trustedIps)) {
            return $this->setTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ps($request, $trustedIps);
        }
    }
     ...
     * @return void
     */
    protected function setTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16ps(Request $request, array $trustedIps)
    {
     ...
     * @return void
     */
    protected function setTVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16gIp(Request $request)
    {
