...
use PHPUnit\Event\TestRunner\DeprecationTriggeredSubscriber as TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16criber;
use PHPUnit\Event\TestRunner\ExecutionFinished;
use PHPUnit\Event\TestRunner\ExecutionFinishedSubscriber;
use PHPUnit\Event\TestRunner\ExecutionStarted;
use PHPUnit\Event\TestRunner\ExecutionStartedSubscriber;
use PHPUnit\Event\TestRunner\WarningTriggered as TestRunnerWarningTriggered;
use PHPUnit\Event\TestRunner\WarningTriggeredSubscriber as TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16er;
    ...
    final class EnsurePrinterIsRegisteredSubscriber implements StartedSubscriber
    {
        ...
        public function notify(Started $event): void
        {
            ...
            $subscribers = [
                ...
                new class($printer) extends Subscriber implements TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16criber
                {
                ...
                new class($printer) extends Subscriber implements TVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16er
                {
