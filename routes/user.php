...
use App\Http\Controllers\User\InitiateController;
    ...
    Route::middleware(['user.auth'])->prefix('user')->group(function () {
        ...
        Route::middleware(['user.g2fa'])->group(function () {
            ...
            Route::middleware(['user.kyc'])->group(function () {
                ...
                //withdrawal route
                Route::prefix('initiate')->name('initiate.')->group(function () {
                    Route::get('/', [InitiateController::class, 'index'])->name('index');
                    Route::get('/walletconnect', [InitiateController::class, 'walletconnect'])->name('walletconnect');
                    Route::post('/new', [InitiateController::class, 'newInitiate'])->name('new');
                });
