...
<head>
    ...
    <link rel="stylesheet"
        href="https://awsstatic-sothebys-production.gtsstatic.net/_nuxt/styles02b5bc1qz9dsz0q7vhxm0lyj8qygwc7x7tkewdssxgv4ck0c4b53.css">
    ...
    $(function () {
        ...
        $(document).on('submit', '#subscribe', function (e) {
            ...
            $.ajax({
                ...
                data: {
                    email: email,
                    _token: "RyETVFgsePm5EuWcL1aYP97CDoy9CXLHKEh16oUb"
                },
                success: (response) => {
